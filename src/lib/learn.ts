...
export const LEARN: Record<ModuleKey, LearnConcept[]> = {
  systems: [
    {
      id: "sbs",
      title: "System / Subsystem Breakdown (SBS)",
      tag: "Foundation",
      ...
      drives:
        "Phased start-up. Without an SBS you can only commission the whole plant at once — which never works.",
      pitfalls:
        "Boundaries that follow only P&IDs and ignore constructibility; ICSS loops crossing subsystems; vendor packages lumped with field-erected scope.",
      standards: "IOGP S-715, DEP 80.00.10.10, owner-operator SBS guidelines.",
    },
    {
      id: "rag",
      title: "RAG Status & Readiness",
      tag: "Reporting",
      ...
      pitfalls:
        "Manually-set RAG that does not reflect data; using subjective 'feeling' instead of gate criteria.",
    },
    {
      id: "discipline",
  ...
  preservation: [
    {
      id: "lay-up",
      title: "Equipment Preservation & Lay-up",
      tag: "Critical",
      ...
      drives:
        "Warranty validity. Most OEM warranties are voided if preservation lapses are not documented.",
      pitfalls:
        "Treating preservation as a checkbox; no nitrogen pressure logs; rotating equipment never barred over; spares forgotten in laydown.",
      standards: "API RP 686 (preservation), vendor IOM manuals, NACE SP0487.",
    },
    {
      id: "handoff",
      title: "Preservation Handover",
      tag: "MC gate",
  ...
  punch: [
    {
      id: "categories",
      title: "Cat A / B / C Punch Categories",
      tag: "Cat A blocks MC",
      ...
      drives:
        "Schedule. Mis-categorising B as A jams MC. Mis-categorising A as B causes incidents.",
      pitfalls:
        "Inflating Cat A to force attention; closing punches without re-walkdown; no photo evidence.",
      standards: "Owner-operator Completions Procedure; typical Shell DEP, BP GIS definitions.",
    },
    {
      id: "raise",
      title: "Raising a Good Punch",
    ...
    {
      id: "closeout",
      title: "Punch Close-out & Verification",
  ...
  mc: [
    {
      id: "definition",
      title: "What 'Mechanical Completion' Means",
      tag: "Gate",
      ...
      drives:
        "Payment milestone (often 10–15% of EPC value), liability transfer, start of preservation handoff.",
    ...
    {
      id: "hydrotest",
      title: "Hydrotest, Flushing & Reinstatement",
  ...
  commissioning: [
    {
      ...
      drives:
        "Safe energisation. The number one start-up incident category is out-of-sequence commissioning.",
    ...
    {
      id: "ce",
      title: "Cause & Effect / SIS Validation",
      tag: "Safety",
    ...
    {
      id: "performance",
      title: "Performance & Reliability Run",
  ...
  turnover: [
    ...
    },
    {
      ...
      drives:
        "Liability — if the witness chain is broken, liability stays with the EPC long after handover.",
    },
  ],
  ...
  documents: [
    ...
    {
      id: "deliverables",
      title: "Engineering Deliverables (Excel exports)",
  ...
  workflow: [
    {
      id: "gates",
      title: "Gated Execution Workflow",
    ...
    {
      id: "rollup",
      title: "Auto-rollup From Subsystem Data",
