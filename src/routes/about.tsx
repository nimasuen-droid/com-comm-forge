  ...
  head: () => ({
    meta: [
      { title: "About — Completions & Commissioning Pro" },
      {
        name: "description",
        content:
          "What Completions & Commissioning Pro does: a field execution platform for EPC mechanical completion, commissioning, punch list, preservation, and turnover management.",
      },
      { property: "og:title", content: "About — Completions & Commissioning Pro" },
      {
        property: "og:description",
        content: "Field execution platform for EPC completions, commissioning and turnover.",
      },
    ],
  }),
  component: AboutPage,
    ...
    <div className="space-y-8 max-w-5xl">
      <header>
        ...
        <p className="text-muted-foreground mt-3 text-base leading-relaxed">
          A field-execution platform for{" "}
          <b>EPC completions, mechanical completion (MC), commissioning, and turnover</b> on oil
          &amp; gas, refinery, petrochemical, LNG, offshore, FPSO, pipeline, and utility projects.
          It replaces the tangle of spreadsheets, PDFs and emails that completions teams normally
          use to drive a project from construction to operations.
        </p>
      </header>
      ...
      <section>
        ...
        <div className="grid md:grid-cols-2 gap-3">
          ...
          />
          <Card
            icon={<Wrench className="text-info" />}
            title="Preservation"
          ...
          />
          <Card
            icon={<ListChecks className="text-warning" />}
            title="Punch List"
          ...
          />
          <Card
            icon={<GitBranch className="text-info" />}
      ...
      <section className="panel p-6 bg-gradient-to-br from-primary/10 to-transparent border-primary/30">
        ...
        <ol className="mt-4 space-y-3 text-sm">
          <Step
            ...
            text="Operator, site, project type, and scope description."
          />
          <Step
            n={2}
            title="Define systems & subsystems"
            text="Set boundaries, disciplines, priority and tags."
          />
          <Step
            n={3}
            title="Run preservation & raise punches"
            text="Capture defects from walkdowns; keep preservation alive during lay-up."
          />
          <Step
            n={4}
            title="Drive subsystems through MC"
            text="Close A-punches, complete walkdown / hydrotest / flushing, declare MC."
          />
          <Step
            n={5}
            title="Commission and energise"
            text="Loop check, function test, dynamic run — by subsystem, in sequence."
          />
          <Step
            n={6}
            title="Hand over to operations"
            text="RFSU → RFO with witness sign-off and final dossier."
          />
        </ol>
      </section>
      ...
      <section className="panel p-6">
        ...
        <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
          On industrial projects, the gap between &ldquo;construction finished&rdquo; and
          &ldquo;plant producing&rdquo; is where schedules slip and budgets blow out. Completions,
          MC, commissioning and turnover are usually run on disconnected spreadsheets, with no
          shared view of subsystem readiness, punch posture or preservation status. This app gives
          the completions team one execution surface — built around how EPC projects actually run —
          so handover decisions are driven by data, not opinion.
        </p>
      </section>
      ...
      <div className="flex flex-wrap gap-3">
        ...
        <Link
          to="/"
          className="inline-flex items-center gap-2 rounded-md border border-border px-4 py-2 text-sm font-semibold hover:bg-muted/50"
        >
          Portfolio Dashboard
        </Link>
      </div>
...
function Step({ n, title, text }: { n: number; title: string; text: string }) {
  return (
    <li className="flex gap-3">
      <span className="flex-shrink-0 h-7 w-7 rounded-md bg-primary/15 border border-primary/30 text-primary font-bold text-xs flex items-center justify-center font-mono">
        {n}
      </span>
      <div>
